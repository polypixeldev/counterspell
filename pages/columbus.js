...
import Hero from "../components/Columbus/Hero";
import About from "../components/Columbus/About";
import Guilds from "../components/Columbus/Guilds";
import Steps from "../components/Columbus/Steps";
import Locations from "../components/Columbus/Locations";
import Faq from "../components/Columbus/Faq";
import Footer from "../components/Columbus/Footer";
	...
	return (
		<>
			<Head>
				...
				<title>Counterspell Columbus</title>
			</Head>
			<div>
				<div
				...
				<a
					href="https://forms.hackclub.com/t/sdMpoL7wK9us?city=rec0fAxwvWTwRv5M3"
				...
				<div className="relative">
					<div className="absolute top-0 left-0 right-0 pointer-events-none -bottom-4 grainy-bg" />
					<div className="absolute top-0 left-0 right-0 -bottom-4 -z-10 bg-dark" />
