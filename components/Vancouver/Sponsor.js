                    ...
                    <React.Fragment key={sponsorIndex}>
                      <a href={sponsor.url} target="_blank"
                        ...
                        <div
                          ...
                          <img
                            src={"/city/Vancouver/sponsors/" + sponsor.fileName}
    ...
    <div className="py-16 bg-[#2A385A] flex flex-col justify-evenly items-center ">
      <div>
        ...
        <div className="text-2xl Sponser text-white font-semibold text-center fusion-pixel">
          ...
          at <a href="mailto:vancouver@counterspell.hackclub.com">vancouver@counterspell.hackclub.com</a>
        </div>
      </div>
      <div className="w-full flex flex-col items-center lg:pt-12 md:pt-8 pt-6">
        ...
        <SponsorTier
          sponsorsPerRow={1}
          sponsorInfo={[
            { fileName: "ltt.jpg", name: "Linus Tech Tips Logo", url: "https://www.youtube.com/user/linustechtips" },
             { fileName: "visst.jpg", name: "VIIST Logo", url: "https://www.visst.ca/" },
          ]}
        />
        {/*Silver Sponsors*/}
        <SponsorTier
