        ...
        <div className="">
          ...
          <div className="flex justify-center mx-12 my-6">
            <div className="flex flex-wrap items-center justify-center gap-6 p-8 border-4 border-dashed border-pink inter">
              <StepCard
                img="/photos/3.png"
                text="Sign up for Counterspell Vancouver"
              />
              <StepCard
                img="/photos/4.png"
              ...
              <StepCard
                img="/photos/5.png"
                text="Start building your game (no experience needed) or whatever you want to  make"
              />
              <StepCard
                img="/photos/6.png"
          ...
          <div className="py-10 mx-6 space-y-4 text-xl uppercase retro">
            <p>
              Counterspell Vancouver will go on for{" "}
              <span className="text-pink">9 hours</span>
              <span className="text-pink"> November 23</span>
            </p>
