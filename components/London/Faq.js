...
const faqData = [
  ...
  },
  {
    ...
    answer: `We have run multiple events around the world. The summer of '21, Hack Club 
        <a href="https://www.youtube.com/watch?v=2BID8_pGuqA&ab_channel=HackClub">chartered a train across America</a>
        and ran the world's longest hackathon on land. Last year, they also ran an outdoors do-it-yourself <a href="https://www.youtube.com/watch?v=O1s5HqSqKi0&ab_channel=HackClub">camping 
  ...
  {
    question: "What can I make at Counterspell London?",
    answer: `At Counterspell London, we're building video games of all kinds! The theme will be revealed at the start of the hackathon.`,
  },
  {
    question: "What do I need to bring to Counterspell London?",
  ...
  },
  {
    ...
    answer: `We're here to help! Ask them to reach out to us at
          <a href="mailto:london@counterspell.hackclub.com">london@counterspell.hackclub.com</a>
          and we'll make sure to answer all their questions!`,
  },
  {
    question: "How can I reach out for more questions?",
    answer: `Contact us! Reach out in the
          <a href="https://hackclub.slack.com/archives/C07PEPXMS3T">#counterspell-london</a>
